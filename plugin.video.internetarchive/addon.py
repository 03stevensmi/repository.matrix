...
def ia_search():
    ...
    if (keyb.isConfirmed()):
        ...
        # https://archive.org/search?query=%28commodore%29+AND+mediatype%3A%28movies%29
        url = 'https://archive.org/search?query=' + search + '+AND+mediatype%3Amovies'  # + sort_value[2:] #+ '&page=2' #+ '&sort=-addeddate'
        # url = 'https://archive.org/search?query=' + search + '&page=2&sort=-addeddate&and%5B%5D=mediatype%3A%22movies%22'
